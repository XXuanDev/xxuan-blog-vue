...
<template>
  <div class="">
    ...
    <div class="headImgBox"
         :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/preview.jpg)'}">
      <div class="scene">
      ...
      <div class="h-information">
        ...
        <img
          :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/avator.jpg'"
          alt="">

        <h2 class="h-description">

          {{ this.$store.state.themeObj.autograph ? this.$store.state.themeObj.autograph : "欢迎来到XXuan的博客！" }}
